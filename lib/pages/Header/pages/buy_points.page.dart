          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Padding(
                    child:Text('Comprar puntos',style: TextStyle(fontSize: 25.h,fontWeight: FontWeight.w600)), 
              ...
              Row(
                children: [
                  Padding(
                    child:Text('Método de pago',style: TextStyle(fontSize: 25.h,fontWeight: FontWeight.w600)), 
                    padding:EdgeInsets.only(left: 25.h)),
                    Spacer(),
                ],
              ),
